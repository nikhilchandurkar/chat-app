import { Avatar, Dialog, DialogTitle, Button, ListItem, Skeleton, Stack, Typography } from "@mui/material";
...
const Notifications = () => {
  ...
  return (
    <Dialog open={isNotification} onClose={closeHandler} fullWidth maxWidth="sm">
